...
final class GettingStartedTest extends TestCase
{
    ...
    {
        // GEGENE getting_started_create_index_md => nb_lines: 5
        ...
        // GEGENE getting_started_add_documents_md => nb_lines: 4 ; replacer: ../datasets/movies.json movies.json
        // ```php
        ...
        // GEGENE getting_started_search_md => nb_lines: 2
        // ```php
